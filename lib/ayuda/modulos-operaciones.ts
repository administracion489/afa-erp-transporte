...
export const MODULOS_OPERACIONES: AyudaModulo[] = [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    faqs: [
      ...
      {
        pregunta: "⭐ Premium y 📦 Estándar, ¿qué cambian exactamente?",
        respuesta:
          "Son el **nivel de servicio**, y ahora se llaman igual en todo el ERP: en el Cotizador, en la cotización, en el Tarifario y en la ficha de cada vehículo. Antes ese mismo botón decía “Full Equipo / Básico” en unas pantallas y “Premium / Estándar” en otras, que eran **dos nombres para la misma decisión**.\n\nAl elegir el nivel pasan tres cosas:\n\n• **Se filtra la lista de unidades.** Con Premium puesto, el selector de “Vehículo de tarifa” solo ofrece las categorías **Premium (menos de 10 años)**; con Estándar, solo las **Estándar (más de 10 años)**. Antes salían las 26 mezcladas y nada impedía cotizar un servicio premium costeado con una unidad de doce años.\n• **Se busca la tarifa de ese nivel.** El Tarifario guarda un precio por nivel para la misma ruta.\n• **Se imprime en el PDF del cliente**, en el ANEXO 1, junto a la descripción y las fotos de la unidad.\n\nDos detalles que evitan sustos:\n\n**Cambiar de nivel no te borra la unidad**: si tenías el Sprinter 17 Premium y pasas a Estándar, se cambia sola a la Sprinter 17 Estándar — la misma capacidad, el otro nivel. Solo si esa categoría **no existe** en el otro nivel se suelta la selección, y la pantalla te dice cuál falta en vez de dejarte el recuadro vacío.\n\n**El comparativo de abajo sigue mostrando los dos niveles**, a propósito: es el único sitio donde ves la diferencia de precio entre una gemela y otra. Si haces clic en una fila del otro nivel, el botón de arriba la sigue.\n\nY si la **unidad de flota** que elegiste está marcada con otro nivel del que estás cotizando, sale un aviso ámbar: el PDF imprime la descripción de esa placa, así que venderías “Premium” con un anexo que dice “cumple ley”. Con unidades **tercerizadas** no sale nunca — de esas el ERP no tiene registrado el equipamiento, y prefiere callarse antes que inventarlo.",
      },
      {
