  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        respuesta:
          "Fíate del dato, pero mira las **anomalías**: el Radar marca por su cuenta cuando algo no cuadra — *Galones exceden tanque*, *Posible duplicado*, *Precio fuera de rango*, *KM menor al actual*, *Consumo excesivo*, *Recarga de madrugada*, *Monto inconsistente*. Las que salen en **rojo** frenan el registro automático; las **ámbar** son observaciones y la recarga entra igual, con la marca puesta.\n\nY mira la columna **Combustible**, que dice con qué tipo se está registrando la carga. El Radar **nunca asume diésel**: si el voucher no lo dice, lo deduce del precio pagado (S/ 7.55 por galón es GLP, no diésel) o de la ficha de la unidad, y lo avisa como *Combustible deducido*. Si no puede saberlo, la recarga **no entra**: queda en revisión como *Combustible sin leer* y lo eliges tú antes de registrar. Y si el voucher dice un tipo pero el precio calza con otro, sale *Combustible no cuadra con el precio* y también espera.\n\nEsa columna importa más de lo que parece en una flota con unidades convertidas a GLP: si una carga de GLP entra como diésel, el rendimiento km/galón de esa unidad mezcla dos combustibles distintos y deja de significar nada, el control de precio se vuelve loco (S/ 7.55 es normal en GLP y absurdo en diésel) y el costo por kilómetro del Cotizador queda mal para todas las cotizaciones de esa unidad.\n\nPara que una recarga **se registre sola** en Combustible tienen que cumplirse todas estas condiciones: que el registro automático esté activado en **Configuración**, que la **placa venga leída del voucher** (si el Radar tuvo que adivinarla, no pasa: no se le carga gasto a una unidad supuesta), que estén la cantidad y el importe, que la lectura tenga confianza suficiente, y que **no haya ninguna anomalía bloqueante**. Ojo con esto último: no todas bloquean — algunas quedan como observación y la recarga entra igual, con la marca puesta.\n\nSi algo de eso falla, la recarga **queda en revisión** con sus motivos, esperando que un humano la mire. Revisa esa cola: lo que se queda ahí no está en tus costos.\n\nEso importa por una razón de dinero: ese consumo es **costo directo** del vehículo y del servicio, y es lo que después hace que la rentabilidad por servicio sea real y no un número bonito. Un voucher duplicado que entra dos veces te hace creer que gastaste de más; uno que nunca entra te hace creer que ganaste de más.\n\nEn la pestaña **Configuración** puedes fijar un **límite diario de gasto en IA (en dólares)**. Cuando se llega al tope, los mensajes no se pierden: quedan pendientes hasta el día siguiente.",
      },
    ],
    relacionadas: [
