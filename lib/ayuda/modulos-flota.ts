  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        respuesta:
          "Ese tablero muestra el total **con una décima** — el último dígito va después de un punto, o en una casilla aparte, o de otro color — y la lectura automática se la pegó al número: 22744.7 leído como 227447. El kilometraje real es el mismo sin ese último dígito.\n\n**No pulses “Aceptar”**: escribiría 230,056 km como kilometraje vigente de una unidad que va por 23,005, y a partir de ahí el mantenimiento preventivo, el costo por kilómetro y el rendimiento de combustible de esa placa quedan mal.\n\nCuando el ERP reconoce el patrón te pone el botón **“Corregir a 23,005”** en la propia fila: pulsarlo abre la ventana de corrección ya rellenada, con el número bueno y la explicación. Confirma y quedan tres cosas hechas de una vez — la lectura mala se anula, se registra la buena con la misma foto y se le enseña a la IA que en ese tablero no debe pegar la décima. Si el botón no aparece, usa **“Rechazar”**, que es la misma ventana pero en blanco, y escribe tú el número correcto.\n\n**Si el aviso es al revés** —una lectura buena acusada de “retroceder” cientos de miles de kilómetros— la mala es la anterior, que ya se aceptó con la décima pegada. El motivo te lo dice y te propone su número. Búscala en la tabla de lecturas de abajo y corrígela con **“Anular”**: al hacerlo el kilometraje vigente se recalcula solo.",
      },
      {
