  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        respuesta:
          "La lectura automática le añadió **un dígito de más al final**: 22744 transcrito como 227447. El kilometraje bueno es el mismo número sin ese último dígito, y los de la izquierda ya coinciden con lo que venía marcando la unidad.\n\n**No pulses “Aceptar”**: escribiría 230,056 km como kilometraje vigente de una unidad que va por 23,005, y a partir de ahí el mantenimiento preventivo, el costo por kilómetro y el rendimiento de combustible de esa placa quedan mal.\n\nCuando el ERP reconoce el patrón te pone el botón **“Corregir a 23,005”** en la propia fila: pulsarlo abre la ventana de corrección ya rellenada, con el número bueno. Confirma y quedan tres cosas hechas de una vez — la lectura mala se anula, se registra la buena con la misma foto y se le enseña a la IA a no añadir ese dígito en esa placa. Si el botón no aparece, usa **“Rechazar”**, que es la misma ventana pero en blanco, y escribe tú el número correcto.\n\n**Si se repite siempre en la misma unidad**, escríbele su guía de tablero en **Radar IA → Configuración → guías de odómetro**: una línea diciendo dónde está el odómetro en ESE tablero y de cuántos dígitos es (por ejemplo, que es de enteros y no lleva décimas, y que no se debe arrastrar el número del trip). Esa guía viaja con cada foto de la placa y es lo que corta el error de raíz.\n\n**Si el aviso es al revés** —una lectura buena acusada de “retroceder” cientos de miles de kilómetros— la mala es la anterior, que se aceptó con el dígito de más. El motivo te lo dice y te propone su número. Búscala en la tabla de lecturas de abajo y corrígela con **“Anular”**: al hacerlo el kilometraje vigente se recalcula solo.",
      },
      {
