...
export const MODULOS_FLOTA: AyudaModulo[] = [
  ...
  // ══════════════════════════════════════════════════════════════════════════
  {
    ...
    faqs: [
      ...
      {
        pregunta: "En “Lecturas por revisar” la misma placa sale siempre con el kilometraje multiplicado por 10 (230,056 en vez de 23,005). ¿Qué hago?",
        respuesta:
          "A la lectura automática **le sobra un dígito**. El caso real de esta flota: el tablero marcaba `ODO 23056 km` y la IA transcribió `230056`, repitiendo el cero.\n\n**No pulses “Aceptar”**: escribiría 230,056 km como kilometraje vigente de una unidad que va por 23,056, y a partir de ahí el mantenimiento preventivo, el costo por kilómetro y el rendimiento de combustible de esa placa quedan mal.\n\nEl ERP reconoce el patrón y te pone en la fila los **kilometrajes posibles** — 23,056 · 23,006 · 23,005 —, uno por botón. Son los números que quedan al quitar un dígito, y el ERP **no elige por ti a propósito**: el dígito que sobra puede estar en cualquier posición y quien tiene la foto es la persona. Abre la foto del tablero con la miniatura de la izquierda, mira qué marca, y pulsa ese número. Confirma y quedan tres cosas hechas de una vez — la lectura mala se anula, se registra la buena con la misma foto y se le enseña a la IA a no repetir el dígito en esa placa. Si no aparece ningún botón, usa **“Rechazar”**, que es la misma ventana en blanco, y escribe tú el número.\n\n**Si se repite siempre en la misma unidad**, escríbele su guía de tablero en **Radar IA → Configuración → guías de odómetro**: una línea diciendo dónde está el odómetro en ESE tablero y de cuántos dígitos es (por ejemplo, que el total es el que va rotulado ODO, de 5 dígitos y sin decimales, y que no se debe tomar el TRIP). Esa guía viaja con cada foto de la placa y es lo que corta el error de raíz.\n\n**Si el aviso es al revés** —una lectura buena acusada de “retroceder” cientos de miles de kilómetros— la mala es la anterior, que se aceptó con el dígito de más. El motivo te lo dice y te propone los números posibles. Búscala en la tabla de lecturas de abajo y corrígela con **“Anular”**: al hacerlo el kilometraje vigente se recalcula solo.",
      },
      {
