    ...
    comoHacer: [
      {
        ...
        pasos: [
          ...
          "Elige el nivel de servicio (⭐ Premium o 📦 Estándar): el texto de la descripción se rellena solo y es el que verá el cliente en la cotización.",
