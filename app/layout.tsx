...
const menuGrupos: { grupo: string; items: MenuItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/mantenimiento/programa", label: "Programa Mnto.",     sub: "Próximos · alertas",  icon: Ic.Calendar,  modulo: "mantenimiento"},
      { href: "/mantenimiento/planes",   label: "Planes Fabricante",  sub: "Plan IA por modelo",  icon: Ic.FileText,  modulo: "mantenimiento"},
      { href: "/mantenimiento/odometro", label: "Odómetro",           sub: "Kilometraje",         icon: Ic.Calculator,modulo: "mantenimiento"},
