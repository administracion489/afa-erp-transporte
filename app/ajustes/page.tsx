        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4 flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <a href="https://facilito.osinergmin.gob.pe" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 mt-2 px-4 py-1.5 rounded-lg bg-amber-600 text-white text-xs font-black hover:bg-amber-700">🌐 Abrir FacilitO OSINERGMIN →</a>
            </div>
          </div>
